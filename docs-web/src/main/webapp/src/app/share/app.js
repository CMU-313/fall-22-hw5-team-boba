 ...
 * Configuring modules.
 */
  .config(($locationProvider, $stateProvider, $httpProvider, RestangularProvider, $translateProvider, tmhDynamicLocaleProvider) => {
    ...
    $httpProvider.defaults.transformRequest = [function (data) {
      var param = function (obj) {
        let query = '';
        let name; let value; let fullSubName; let subName; let subValue; let innerObj; let
          i;
