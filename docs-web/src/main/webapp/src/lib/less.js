...
(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f(); } else if (typeof define === 'function' && define.amd) { define([], f); } else { let g; if (typeof window !== 'undefined') { g = window; } else if (typeof global !== 'undefined') { g = global; } else if (typeof self !== 'undefined') { g = self; } else { g = this; }g.less = f(); } }(() => {
  let define; let module; let exports; return (function e(t, n, r) { function s(o, u) { if (!n[o]) { if (!t[o]) { const a = typeof require === 'function' && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); const f = new Error(`Cannot find module '${o}'`); throw f.code = 'MODULE_NOT_FOUND', f; } const l = n[o] = { exports: {} }; t[o][0].call(l.exports, (e) => { const n = t[o][1][e]; return s(n || e); }, l, l.exports, e, t, n, r); } return n[o].exports; } var i = typeof require === 'function' && require; for (let o = 0; o < r.length; o++)s(r[o]); return s; }({
    1: [function (require, module, exports) {
      const { addDataAttr } = require('./utils');
   ...
   */
    ...
    3: [function (require, module, exports) {
      ...
      module.exports = {
        createCSS(document, styles, sheet) {
    ...
    5: [function (require, module, exports) {
      ...
      module.exports = function (window, less, options) {
        function errorHTML(e, rootHref) {
          ...
          const elem = window.document.createElement('div'); let timer; let content; const
            errors = [];
    ...
    6: [function (require, module, exports) {
      ...
      module.exports = function (options, logger) {
        ...
        FileManager.prototype.loadFile = function loadFile(filename, currentDirectory, options, environment, callback) {
          ...
          this.doXHR(href, options.mime, (data, lastModified) => {
            // per file cache
            fileCache[href] = data;
    ...
    //
      ...
      module.exports = function (window, options) {
        ...
        function loadStyleSheet(sheet, callback, reload, remaining, modifyVars) {
          ...
          fileManager.loadFile(sheet.href, null, instanceOptions, environment, (e, loadedFile) => {
            if (e) {
              callback(e);
              return;
            }
        ...
        less.refresh = function (reload, modifyVars, clearFileCache) {
          ...
          return new Promise((resolve, reject) => {
            let startTime; let endTime; let totalMilliseconds; let
              remainingSheets;
 ...
 */
    ...
    15: [function (require, module, exports) {
      ...
      abstractFileManager.prototype.pathDiff = function pathDiff(url, baseUrl) {
        ...
        let i; let max; let urlDirectories; let baseUrlDirectories; let
          diff = '';
      ...
      abstractFileManager.prototype.extractUrlParts = function extractUrlParts(url, baseUrl) {
        ...
        const returner = {}; let directories = []; let i; let
          baseUrlParts;
    ...
    26: [function (require, module, exports) {
      ...
      functionRegistry.addMultiple({
        ...
        pow(x, y) {
          ...
          return new Dimension(x.value ** y.value, x.unit);
        },
        percentage(n) {
      ...
      functionRegistry.addMultiple({
        ...
        escape(str) {
          return new Anonymous(
            encodeURI(str.value).replace(/=/g, '%3D').replace(/:/g, '%3A').replace(/#/g, '%23')
              .replace(/;/g, '%3B')
              .replace(/\(/g, '%28')
              .replace(/\)/g, '%29'),
          );
    ...
    28: [function (require, module, exports) {
      module.exports = function (environment) {
        ...
        functionRegistry.add('svg-gradient', function (direction) {
          ...
          let i; let color; let position; let positionValue; let
            alpha;
        ...
        ImportManager.prototype.push = function (path, tryAppendLessExtension, currentFileInfo, importOptions, callback) {
          ...
          const loadFileCallback = function (loadedFile) {
            ...
            if (importOptions.plugin) {
              new FunctionImporter(newEnv, newFileInfo).eval(contents, (e, root) => {
    ...
    31: [function (require, module, exports) {
      module.exports = function (environment, fileManagers) {
        let SourceMapOutput; let SourceMapBuilder; let ParseTree; let ImportManager; let
          Environment;
    ...
    34: [function (require, module, exports) {
      ...
      module.exports = function (SourceMapBuilder) {
        ...
        ParseTree.prototype.toCSS = function (options) {
          let evaldRoot; const result = {}; let
            sourceMapBuilder;
          try {
    ...
    // Split the input into chunks.
      module.exports = function (input, fail) {
        ...
        let chunkerCurrentIndex; let currentChunkStartIndex; let cc; let cc2; let
          matched;
        ...
        for (chunkerCurrentIndex = 0; chunkerCurrentIndex < len; chunkerCurrentIndex++) {
          ...
          switch (cc) {
            ...
            case 96: // ", ' and `
              ...
              for (chunkerCurrentIndex += 1; chunkerCurrentIndex < len; chunkerCurrentIndex++) {
            ...
            case 47: // /, check for comment
              ...
              if (cc2 == 47) {
                // //, find lnfeed
                for (chunkerCurrentIndex += 2; chunkerCurrentIndex < len; chunkerCurrentIndex++) {
                  cc2 = input.charCodeAt(chunkerCurrentIndex);
                ...
                for (chunkerCurrentIndex += 2; chunkerCurrentIndex < len - 1; chunkerCurrentIndex++) {
                  cc2 = input.charCodeAt(chunkerCurrentIndex);
      ...
      const Parser = function Parser(context, imports, fileInfo) {
        ...
        return {
          ...
          parse(str, callback, additionalData) {
            let root; let error = null; let globalVars; let modifyVars; let ignored; let
              preText = '';
            ...
            try {
              parserInput.start(str, context.chunkInput, (msg, index) => {
                throw new LessError({
                  index,
                  type: 'Parse',
                  message: msg,
          ...
          parsers: parsers = {
            ...
            entities: {
              ...
              //
              quoted() {
                let str; const index = parserInput.i; let
                  isEscaped = false;
              ...
              //
              call() {
                let name; let nameLC; let args; let alpha; const
                  index = parserInput.i;
              ...
              arguments() {
                ...
                let expressions = [];
                let isSemiColonSeparated; let value; let
                  arg;
              ...
              colorKeyword() {
                parserInput.save();
                const { autoCommentAbsorb } = parserInput;
                parserInput.autoCommentAbsorb = false;
            ...
            //
            extend(isRule) {
              let elements; let e; const index = parserInput.i; let option; let extendList; let
                extend;
            ...
            mixin: {
              ...
              call() {
                ...
                let elements; let elem; let e; let c; let
                  args;
              ...
              //
              definition() {
                let name; let params = []; let match; let ruleset; let cond; let
                  variadic = false;
            ...
            //
            selector(isLess) {
              const index = parserInput.i; let elements; let extendList; let c; let e; let allExtends; let when; let
                condition;
            ...
            //
            ruleset() {
              let selectors; let s; let rules; let
                debugInfo;
            ...
            rule(tryAnonymous) {
              let name; let value; const startOfRule = parserInput.i; const c = parserInput.currentChar(); let important; let merge; let
                isVariable;
            ...
            importOptions() {
              let o; const options = {}; let optionName; let
                value;
            ...
            media() {
              let features; let rules; let media; let debugInfo; const
                index = parserInput.i;
            ...
            directive() {
              ...
              let hasIdentifier; let hasExpression; let hasUnknown; let hasBlock = true; let
                isRooted = true;
            ...
            multiplication() {
              let m; let a; let op; let operation; let
                isSpaced;
              m = this.operand();
              if (m) {
            ...
            conditions() {
              let a; let b; const index = parserInput.i; let
                condition;
            ...
            ruleProperty() {
              let name = []; const index = []; let s; let
                k;
   ...
   */
      ...
      module.exports = function (root, options) {
        ...
        if (options.pluginManager) {
          ...
          for (i = 0; i < pluginVisitors.length; i++) {
            ...
            } else if (pluginVisitor.isPreVisitor) {
    ...
    50: [function (require, module, exports) {
      ...
      Color.prototype.toCSS = function (context, doNotCompress) {
        const compress = context && context.compress && !doNotCompress; let color; let
          alpha;
        ...
        if (alpha < 1) {
          return `rgba(${this.rgb.map((c) => clamp(Math.round(c), 255)).concat(clamp(alpha, 1))
            .join(`,${compress ? '' : ' '}`)})`;
        }
      ...
      Color.prototype.toHSL = function () {
        ...
        const max = Math.max(r, g, b); const
          min = Math.min(r, g, b);
        let h; let s; const l = (max + min) / 2; const
          d = max - min;
    ...
    54: [function (require, module, exports) {
      ...
      debugInfo.asMediaQuery = function (ctx) {
        ...
        return `@media -sass-debug-info{filename{font-family:${
          filenameWithProtocol.replace(/([.:\/\\])/g, (a) => {
            if (a == '\\') {
              a = '\/';
            }
            return `\\${a}`;
    ...
    57: [function (require, module, exports) {
      ...
      Directive.prototype.eval = function (context) {
        let mediaPathBackup; let mediaBlocksBackup; let { value } = this; let
          { rules } = this;
      ...
      Directive.prototype.outputRuleset = function (context, output, rules) {
        const ruleCnt = rules.length; let
          i;
    ...
    64: [function (require, module, exports) {
      ...
      JsEvalNode.prototype.evaluateJavaScript = function (expression, context) {
        ...
        expression = expression.replace(/@\{([\w-]+)\}/g, (_, name) => that.jsify(new Variable(`@${name}`, that.index, that.currentFileInfo).eval(context)));
    ...
    65: [function (require, module, exports) {
      ...
      const Keyword = function (value) { this.value = value; };
    ...
    67: [function (require, module, exports) {
      ...
      MixinCall.prototype.eval = function (context) {
        ...
        const defNone = 0; const defTrue = 1; const defFalse = 2; let count; let originalRuleset; let
          noArgumentsFilter;
            ...
            for (m = 0; m < candidates.length; m++) {
              ...
              if ((candidate === defNone) || (candidate === defaultResult)) {
                try {
                  ...
                  throw {
                    message: e.message, index: this.index, filename: this.currentFileInfo.filename, stack: e.stack,
                  };
                }
              }
            }
    ...
    68: [function (require, module, exports) {
      ...
      Definition.prototype.evalParams = function (context, mixinEnv, args, evaldArguments) {
        ...
        let i; let j; let val; let name; let isNamedFound; let argIndex; let
          argsLength = 0;
      ...
      Definition.prototype.matchArgs = function (args, context) {
        const allArgsCnt = (args && args.length) || 0; let len; const
        ...
        } else if (requiredArgsCnt < (this.required - 1)) {
          return false;
        }
    ...
    74: [function (require, module, exports) {
      ...
      Rule.prototype.eval = function (context) {
        let strictMathBypass = false; let { name } = this; let evaldValue; let
          { variable } = this;
    ...
    76: [function (require, module, exports) {
      ...
      Ruleset.prototype.eval = function (context) {
        ...
        let selCnt; let selector; let i; let
        ...
        const rsRules = ruleset.rules; let
      ...
      Ruleset.prototype.rulesets = function () {
        ...
        const filtRules = []; const { rules } = this; const cnt = rules.length;
        let i; let
          rule;
      ...
      Ruleset.prototype.genCSS = function (context, output) {
        ...
        function isRulesetLikeNode(rule) {
          ...
          } if (typeof rule.isRulesetLike === 'function') {
            return rule.isRulesetLike();
          }
      ...
      Ruleset.prototype.joinSelector = function (paths, context, selector) {
        ...
        function addReplacementIntoPath(beginningPath, addPath, replacedElement, originalSelector) {
          let newSelectorPath; let lastSelector; let
            newJoinedSelector;
          ...
          if (addPath.length > 0) {
            ...
            let { combinator } = replacedElement;
        ...
        function replaceParentSelector(paths, context, inSelector) {
          ...
          // == [[.a] [.c]] [[.b] [.c]]
          //
          let i; let j; let k; let currentElements; let newSelectors; let selectorsMultiplied; let sel; let el; let hadParentSelector = false; let length; let
            lastSelector;
          ...
          for (i = 0; i < inSelector.elements.length; i++) {
            ...
            if (el.value !== '&') {
              ...
              if (nestedSelector != null) {
                ...
                const nestedPaths = []; var replaced; const
    ...
    79: [function (require, module, exports) {
      ...
      Unit.prototype.usedUnits = function () {
        let group; const result = {}; let mapUnit; let
          groupName;
      ...
      Unit.prototype.cancel = function () {
        const counter = {}; let atomicUnit; let
          i;
    ...
    84: [function (require, module, exports) {
      ...
      ExtendFinderVisitor.prototype = {
        ...
        visitRuleset(rulesetNode, visitArgs) {
          ...
          let i; let j; let extend; const allSelectorsExtendList = []; let
            extendList;

          // get &:extend(.a); rules which apply to all selectors in this ruleset
          const { rules } = rulesetNode;
      ...
      ProcessExtendsVisitor.prototype = {
        ...
        doExtendChaining(extendsList, extendsListTarget, iterationCount) {
          ...
          let extend; let targetExtend; let
            newExtend;
        ...
        visitRuleset(rulesetNode, visitArgs) {
          ...
          const selectorsToAdd = []; const extendVisitor = this; let
            selectorPath;
          ...
          for (extendIndex = 0; extendIndex < allExtends.length; extendIndex++) {
            for (pathIndex = 0; pathIndex < rulesetNode.paths.length; pathIndex++) {
              ...
              const { extendList } = selectorPath[selectorPath.length - 1];
        ...
        findMatch(extend, haystackSelectorPath) {
          ...
          const potentialMatches = []; let potentialMatch; const
            matches = [];
      ...
      ToCSSVisitor.prototype = {
        ...
        visitRuleset(rulesetNode, visitArgs) {
          ...
          if (!rulesetNode.root) {
            ...
            const nodeRules = rulesetNode.rules; let
